...
public class Payment extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Payment_dte = new com.toedter.calendar.JDateChooser();
        OrderCbx = new javax.swing.JComboBox<>();
        jLabel5 = new javax.swing.JLabel();
        CustCbx = new javax.swing.JComboBox<>();
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 60, -1));
        ...
        add(Update_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 370, 170, -1));
        ...
        add(ClearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 370, 160, -1));
        ...
        add(Delete_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 160, -1));
        ...
        add(Additem_Btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 370, 170, -1));
        add(Payment_dte, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 400, 30));

        OrderCbx.setBackground(new java.awt.Color(255, 102, 0));
        OrderCbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OrderCbxActionPerformed(evt);
            }
        });
        add(OrderCbx, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 400, 30));
        ...
        CustCbx.setBackground(new java.awt.Color(255, 102, 0));
        CustCbx.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CustCbxActionPerformed(evt);
            }
        });
        add(CustCbx, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 400, 30));
    ...
    private void Update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update_btnActionPerformed
        ...
        Date payment_date = Payment_dte.getDate();     
        String PaymentDateConverted = df.format(payment_date);
        double Quantity = Double.parseDouble(Quan_txt.getText());
        
        String qrry = "UPDATE inventory SET "
                 + "Inv_Quantity = " + Quantity +","
                 
                 + "Expiry_date = '" + PaymentDateConverted +"' WHERE Inv_ID = "+InvID;
    ...
    private void Item_boxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Item_boxActionPerformed
        ...
        for (InventoryModel item : InvList) {
            if(InvID == item.getInvID()){
                ...
                Payment_dte.setDate(Date.from(item.getExpiry_date().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            }
        }
        }
    ...
    private void Additem_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Additem_BtnActionPerformed
        ...
        try {
            ...
            Date Expirydate = Payment_dte.getDate();     
...
//                 + "Expiry_date = '" + ExpiryDateConverted +"' WHERE Inv_ID = "+InvID;
    ...
    private void OrderCbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrderCbxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_OrderCbxActionPerformed

    private void CustCbxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CustCbxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CustCbxActionPerformed
    private void clearData(){
        LocalDate dateNow = LocalDate.now();
        AddItem_txt.setText("");
        Quan_txt.setText("");        
        Payment_dte.setDate(Date.from(dateNow.atStartOfDay(ZoneId.systemDefault()).toInstant()));
    }
    ...
    private javax.swing.JComboBox<String> CustCbx;
    private javax.swing.JButton Delete_btn;
    private javax.swing.JComboBox<String> Item_box;
    private javax.swing.JComboBox<String> OrderCbx;
    private com.toedter.calendar.JDateChooser Payment_dte;
